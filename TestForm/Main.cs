...
namespace Dalssoft.TestForm
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSize.CheckOnClick = true;
            ...
            // mnuTbStraightLink
            // 
            this.mnuTbStraightLink.Name = "mnuTbStraightLink";
            ...
            // mnuTbRightAngleLink
            // 
            this.mnuTbRightAngleLink.Name = "mnuTbRightAngleLink";
            ...
            // contextMenu_Zoom
            // 
            this.contextMenu_Zoom.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.mnuZoom_10,
            this.mnuZoom_25,
            this.mnuZoom_50,
            this.mnuZoom_75,
            ...
            // mnuShowDebugLog
            // 
            this.mnuShowDebugLog.Name = "mnuShowDebugLog";
            ...
            // TbCommentBoxNode
            // 
            this.TbCommentBoxNode.Name = "TbCommentBoxNode";
        ...
        private void Action_None()
        {
            ...
            // btnAdd.Checked = false; // ToolStripSplitButton doesn't support Checked
            btnDelete.Checked = false;
            // btnConnect.Checked = false; // ToolStripSplitButton doesn't support Checked
        ...
        {
            Action_None();
            // btnAdd.Checked = true; // ToolStripSplitButton doesn't support Checked
            switch (e)
            {
        ...
        private void Action_Connect()
        {
            ...
            // btnConnect.Checked = true; // ToolStripSplitButton doesn't support Checked
            if (changeDocumentProp)
        ...
        private void File_Open()
        {
            ...
            openFileDialog1.Filter = "ȫ��dgn�ļ�(*.dgn)|*.dgn|ȫ���ļ�(*.*)|*.*";
        ...
        private void File_SaveAs()
        {
            ...
            saveFileDialog1.Filter = "ȫ��dgn�ļ�(*.dgn)|*.dgn|ȫ���ļ�(*.*)|*.*";
        ...
        private void toolBar1_ItemClicked(object sender, System.Windows.Forms.ToolStripItemClickedEventArgs e)
        {
